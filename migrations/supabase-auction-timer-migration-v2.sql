-- Migration for Auction Timer Feature (Updated)
...
DROP POLICY IF EXISTS "Soloists can view their own contact reveals" ON public.contact_reveals;
DROP POLICY IF EXISTS "Ask owners can create contact reveals" ON public.contact_reveals;
